...
"#usernameInput, #deviceInput, #aesInput", "close", "magnificPopup", "مبروك", "بنجاح ", " لقد تم إتصال الحساب", "closed", "open", "Error", "Please select your server.", "error", "المرجو إدخال حسابك في اللعبة", "You are already connected.", ".connect-button", "activated", "hasClass", ".", "OPTION_", "addClass", "slow", "#lives_select", "#coins_select", "#bars_select", "locker", "#gen_modal", "fadeIn", ".gen-console-area", "fadeOut", ".generator-section", "عليك أن تدخل حسابك في اللعبة أولاً", 
".gen-button", ".connect_progressbar", "0%", "%", ".gen-dev-console", ".dev-console-text", "height", ".gen-loading-msg", '<li><i class="fas fa-angle-right"></i> ', "</li>", "appendTo", "hide", '<li class="console-green-text"><i class="fas fa-angle-right"></i> ', '<li class="console-red-text"><i class="fas fa-angle-right"></i> ', '<li class="console-yellow-text"><i class="fa fa-angle-right"></i> ', "Performing server authentication: connect_to_server(332FS2);", "Successully obtained server status verification", 
...
"1.1em solid #29be62", ".loading-spinner", "Items generation successful.", "Sending item to (", ") from our server.", "Initating redirect procedure.", "يجب تأكيد أنك إنسان", "You can post a message after using the generator tool.", ".comment_btn", "ready"];
